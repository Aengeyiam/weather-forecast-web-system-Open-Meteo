...
const Utils = {
    getWeatherDesc(code) {
        const m = {
            0:{icon:'\u2600\ufe0f',text:'\u6674'}, 1:{icon:'\u{1F324}\ufe0f',text:'\u5927\u90e8\u6674'},
            2:{icon:'\u26c5',text:'\u591a\u4e91'}, 3:{icon:'\u2601\ufe0f',text:'\u9634'},
            45:{icon:'\u{1F32B}\ufe0f',text:'\u96fe'}, 48:{icon:'\u{1F32B}\ufe0f',text:'\u96fe\u51a5'},
            51:{icon:'\u{1F326}\ufe0f',text:'\u5c0f\u6bdb\u6bdb\u96e8'}, 53:{icon:'\u{1F326}\ufe0f',text:'\u4e2d\u6bdb\u6bdb\u96e8'},
            55:{icon:'\u{1F327}\ufe0f',text:'\u5927\u6bdb\u6bdb\u96e8'},
            61:{icon:'\u{1F327}\ufe0f',text:'\u5c0f\u96e8'}, 63:{icon:'\u{1F327}\ufe0f',text:'\u4e2d\u96e8'},
            65:{icon:'\u{1F327}\ufe0f',text:'\u5927\u96e8'},
            71:{icon:'\u{1F328}\ufe0f',text:'\u5c0f\u96ea'}, 73:{icon:'\u{1F328}\ufe0f',text:'\u4e2d\u96ea'},
            75:{icon:'\u{1F328}\ufe0f',text:'\u5927\u96ea'},
            80:{icon:'\u{1F326}\ufe0f',text:'\u9635\u96e8'}, 81:{icon:'\u{1F327}\ufe0f',text:'\u4e2d\u9635\u96e8'},
            82:{icon:'\u26c8\ufe0f',text:'\u5927\u9635\u96e8'},
            85:{icon:'\u{1F328}\ufe0f',text:'\u5c0f\u9635\u96ea'}, 86:{icon:'\u{1F328}\ufe0f',text:'\u5927\u9635\u96ea'},
            95:{icon:'\u26c8\ufe0f',text:'\u96f7\u66b4'}, 96:{icon:'\u26c8\ufe0f',text:'\u96f7\u66b4+\u51b0\u96f9'},
            99:{icon:'\u26c8\ufe0f',text:'\u5f3a\u96f7\u66b4'}
        };
        return m[code] || { icon: '\u{1F308}', text: '\u672a\u77e5' };
    },
